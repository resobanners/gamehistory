    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* AUTONOMOUS GRID SYSTEM */
        .grid-months { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 16px; }
        ...
        /* AUTO-FILL LOGIC: Last item expands if it's the only one in its row */
        .game-card:last-child:nth-child(odd) { grid-column: span 2; }
        ...
        /* PREVENTS STRETCHING: Image crops instead of pulling */
        .game-card img {
          width: 100%;
          height: 100%;
          object-fit: cover; 
        ...
        .is-exporting .grid-months { grid-template-columns: repeat(4, 1fr) !important; width: 1400px; padding: 20px; }
        .is-exporting .month-col { height: 550px !important; }
        .is-exporting .games-grid { grid-auto-rows: 1fr; } /* Math-based equal height rows */
        .is-exporting .add-btn, .is-exporting .remove-btn { display: none !important; }

        /* MODAL */
        .modal-backdrop { position: fixed; inset: 0; background: rgba(0,0,0,0.85); display: flex; align-items: center; justify-content: center; z-index: 100; backdrop-filter: blur(5px); }
        ...
        .search-input { width: 100%; background: #0e0e12; border: 1px solid #3d3a50; padding: 15px; color: white; border-radius: 10px; outline: none; margin: 20px; width: calc(100% - 40px); }
        ...
        .search-card img { width: 100%; aspect-ratio: 3/4; object-fit: cover; border-radius: 5px; }
      `}</style>
