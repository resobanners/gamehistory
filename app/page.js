    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .share-btn { background: #2a2835; color: #c9b8ff; border: 1px solid #3d3a50; padding: 10px 20px; border-radius: 12px; cursor: pointer; font-weight: 700; }
        ...
        /* POSTER OTONOM TASARIM - TÜM SENARYOLAR İÇİN TEK FIX */
        .is-exporting .grid-months { grid-template-columns: repeat(4, 1fr) !important; width: 1400px !important; gap: 20px !important; padding: 30px; }
        .is-exporting .month-col { height: 600px !important; display: flex !important; flex-direction: column !important; overflow: hidden; }
        
        .is-exporting .games-grid { 
            display: grid !important; 
            grid-template-columns: repeat(2, 1fr) !important;
            grid-auto-rows: 1fr !important; /* Satır yüksekliklerini matematiksel olarak eşit böler */
            flex: 1 !important;
            gap: 8px !important;
        }

        /* OTONOM GENİŞLEME: Eğer son oyun tek kalmışsa (yani sayısı tekse), tüm satırı kaplar */
        .is-exporting .game-card:last-child:nth-child(odd) {
            grid-column: span 2 !important;
        }

        .is-exporting .game-card { aspect-ratio: auto !important; height: 100% !important; }
